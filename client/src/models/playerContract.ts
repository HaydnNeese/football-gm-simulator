export interface PlayerContract {
  ...
  bonuses?: {
    signingBonus?: number;
    rosterBonusPerYear?: Record<string, number>;
    workoutBonusPerYear?: Record<string, number>;
    incentiveBonusPerYear?: Record<string, number>;
  };
  salaryByYear?: Record<string, number>;
  capHitByYear?: Record<string, number>;
  deadCapByYear?: Record<string, number>;
  optOutYears?: number[];
